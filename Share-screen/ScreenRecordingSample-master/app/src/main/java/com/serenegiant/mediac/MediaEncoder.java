package com.serenegiant.mediac;
/*
...
public abstract class MediaEncoder implements Runnable {
     ...
     */
    protected final WeakReference<com.serenegiant.mediac.MediaMuxerWrapper> mWeakMuxer;
    /**
    ...
    public MediaEncoder(final com.serenegiant.mediac.MediaMuxerWrapper muxer, final MediaEncoderListener listener) {
    	if (listener == null) throw new NullPointerException("MediaEncoderListener is null");
    	if (muxer == null) throw new NullPointerException("MediaMuxerWrapper is null");
		mWeakMuxer = new WeakReference<com.serenegiant.mediac.MediaMuxerWrapper>(muxer);
    ...
    public String getOutputPath() {
    	final com.serenegiant.mediac.MediaMuxerWrapper muxer = mWeakMuxer.get();
...
//********************************************************************************
    ...
    protected void release() {
        ...
        if (mMuxerStarted) {
       		final com.serenegiant.mediac.MediaMuxerWrapper muxer = mWeakMuxer != null ? mWeakMuxer.get() : null;
       		if (muxer != null) {
       			try {
           			muxer.stop();
    			} catch (final Exception e) {
